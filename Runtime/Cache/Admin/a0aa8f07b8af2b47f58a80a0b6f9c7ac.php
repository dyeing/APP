...
<body class="login">
	<div id="login">
		<form action="<?php echo U('Admin/Login/login');?>" method="post" class="login-from">
			<h3>
			...
			<div class="itembox" id="itembox">
				...
				<div class="item verifycode">
					...
					<input type="text" name="verifycode" placeholder="请填写验证码" autocomplete="off">
					<a class="reloadverify" title="换一张" href="javascript:void(0)">换一张？</a>
				</div>
				<div>
					<img src="<?php echo U('Admin/Login/verify');?>" width="190px" height="50px" id="code">
				</div>
			</div>
